...
\begin{table}[h]
	\input{table.tex}
	\caption{Random variables(RV) X,Y and X,Y}\label{table1:}
\end{table}

		 Three diamonds and one spade can be selected such that  X,Y = $\cbrak{00,10,20,31}$ where X denotes any card   and Y denotes whether the card is diamond or spade.
